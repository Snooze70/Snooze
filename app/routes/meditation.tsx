  ...
  return (
    <>
        ...
        <div className="right-section 0 w-1/2 p-2 text-green-800">
          ...
          <div className="flex flex-row gap-4 items-center justify-evenly my-4">
            ...
            <div className="text-center">
              ...
              <span className="text-gray-400 my-2 font-bold">In progress</span>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col m-12">
        ...
        <div className="flex flex-col items-center gap-4 md:flex-row  ">
          <div className="image">
            <img src="/public/p-header.png" alt="Flower pic" className="h-40" />
          </div>
          <div className="text-green-800">
            <h2 className="text-3xl font-bold  my-4">Personalized PlayList</h2>
            <p className="my-4 text-sm">
